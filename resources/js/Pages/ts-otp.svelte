                  ...
                  <div class="sm:p-5 lg:px-10 lg:py-8">
                    <form on:submit|preventDefault="{login}" class="space-y-6">
                      <div class="space-y-1">
                        ...
                        <input bind:value={otp} class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" id="otp" placeholder="123456" />
                      </div>
