            ...
            <div class="py-6 lg:py-0 w-full md:w-8/12 lg:w-6/12 xl:w-4/12 relative">
              ...
              <div class="mb-8 text-center">
                ...
                <p class="text-gray-500">
                  Rekrutmen 1000 CyberTroops 0<sup>3</sup>
                </p>
              </div>
              <!-- END Header -->
                  ...
                  <div class="sm:p-5 lg:px-10 lg:py-8">
                    <form on:submit|preventDefault="{login}" class="space-y-6">
                      <div class="space-y-1">
                        ...
                        <Select placeholder="Pilih Kota/Kabupaten" bind:value="{form.city}" lists="{items}"></Select>
                    </div>
                      <div class="space-y-1">
                        <label for="phone" class="font-medium">No Whatsapp</label>
                        <input bind:value={phone} class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" id="phone" required placeholder="081351941xxx" />
                      </div>
                      <div class="space-y-1">
                        <label for="twitter_username" class="font-medium">Username Twittter</label>
                        <input bind:value={form.twitter_username} class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="text" required id="twitter_username" placeholder="islamictroops" />
                      </div>
...
<div class="p-4 md:p-5 rounded text-orange-700 bg-orange-100">
  <div class="flex items-center">
    ...
    <h3 class="font-semibold grow">
      Pendaftaran Terbatas hanya 1000 orang.
    </h3> 
  </div>
</div>
<!-- END Warning Alert -->
