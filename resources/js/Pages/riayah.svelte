               ...
               <div class="mt-1">
                ...
                <div class="mt-5 flex items-center justify-between space-x-2">
                    <div>
                        ...
                        <div>
                            <!-- Badge Pill (gray) -->
                            <div class="font-semibold inline-flex px-2 py-1 leading-4 text-sm rounded-full text-gray-600 bg-gray-100">{item.status}</div>
                          </div>
                    </div> 
                    
                 <div class="flex gap-2">
                  <Link href="/riayah/{item.id}/edit"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
