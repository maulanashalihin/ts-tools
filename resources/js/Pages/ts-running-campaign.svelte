    ...
    <div class="container my-3 grid gap-3  lg:my-6 max-w-lg mx-auto ">
        ...
        <div class="bg-white p-4 ">
            ...
            <div class="  mt-3 flex gap-3">
                ...
                <a on:click={()=>{UpdateScore(true);tweet_done = [...tweet_done,item.id]}} href="https://twitter.com/intent/tweet?text={encodeURIComponent(item.content+hashtag_text+"\n"+generateUniqCode())}" rel="noreferrer" target="_blank" class="  py-1  inline-flex">
    ...
    <div class="container my-3 grid gap-3  lg:my-6 max-w-lg mx-auto ">
        ...
        <div class="bg-white p-4 ">
            ...
            <div class="  mt-3"> 
                ...
                <a on:click={()=>{UpdateScore(true);reply_done = [...reply_done,item.id]}} href="https://twitter.com/intent/tweet?in_reply_to={item.tweet_id}&text={encodeURIComponent(pickTweet()+hashtag_text+"\n"+generateUniqCode())}" rel="noreferrer" target="_blank" class="  py-1  inline-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
...
<Modal bind:show="{mediaModal}" title="Pilih Media untuk Tweet">
    ...
    <div class="grid grid-cols-2 p-6 gap-3">
        {#each medias as item}
            ...
            <a on:click={()=>{UpdateScore(true);tweet_done = [...tweet_done,active_tweet.id];mediaModal = false}} href="https://twitter.com/intent/tweet?text={encodeURIComponent(active_tweet.content+hashtag_text+"\n"+generateUniqCode())}+{item.twitter_url}" rel="noreferrer" target="_blank" class="  py-1  inline-flex">
