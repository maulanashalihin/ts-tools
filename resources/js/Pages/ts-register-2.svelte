            ...
            <div class="py-6 lg:py-0 w-full md:w-8/12 lg:w-6/12 xl:w-4/12 relative">
              ...
              <div class="mb-8 text-center">
                <h1 class="text-4xl font-bold inline-flex items-center mb-1 space-x-3">
                  ...
                  <span>Welcome Troopers!</span>
                </h1>
                <p class="text-gray-500 text-lg">
                  Form Pendaftaran TS Tools
                </p>
              </div>
              <!-- END Header -->
                  ...
                  <div class="sm:p-5 lg:px-10 lg:py-8">
                    <form on:submit|preventDefault="{login}" class="space-y-6">
                      ...
                      <div class="space-y-1">
                        ...
                        <input bind:value={phone} class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" id="phone" placeholder="081351941xxx" />
                      </div>
                      <div class="space-y-1">
