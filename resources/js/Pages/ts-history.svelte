        ...
        <div class="bg-white p-4  space-y-6">
           ...
           <div class="space-y-1">
            ...
            <div class="flex items-center w-full h-5 bg-orange-100 rounded-lg overflow-hidden">
              <div
                role="progressbar"
                aria-valuenow="{Math.floor(item.current_round / item.round_number * 100)}"
                aria-valuemin="0"
                aria-valuemax="100"
                ...
                style="width: {Math.floor(item.current_round / item.round_number * 100)}%;"
              >
              {Math.floor(item.current_round / item.round_number * 100)}%
              </div>
            </div>
          </div>
           {/if}
