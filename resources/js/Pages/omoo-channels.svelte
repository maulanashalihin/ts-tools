...
<TsLayouts>
    ...
    <div class="container xl:max-w-7xl mx-auto p-4 lg:p-8">
        ...
        <div class="grid lg:grid-cols-3 gap-4 mt-5">
            {#each channels as item}
                 ...
                 <div class="bg-white rounded text-center p-4">
                    ...
                    <div class="flex gap-3 justify-center mt-3">
                        <a use:inertia class="border px-3 py-1" href="/channel/{item.id}/edit">
                            Edit Channel
                        </a>
                        <a use:inertia class="border px-3 py-1" href="/channel/{item.id}">
                            Post Konten
                        </a>
                    </div>
                </div>
            ...
            <a use:inertia style="min-height : 120px" class="border-2   rounded text-center flex justify-center items-center" href="/channel/create">
