...
>
  ...
  <header
    id="page-header"
    class="  items-center bg-orange-600 z-1"
  >
    <div class="      px-4 lg:px-8">
      <div class="flex  justify-between py-4">
        ...
        <div class="flex items-center space-x-2 lg:space-x-6">
          ...
          <a
            href="/home"
            class="group inline-flex items-center space-x-2 font-semibold text-lg tracking-wide text-white hover:text-orange-300 active:text-gray-200"
          >
          ...
          <nav class="hidden lg:flex lg:items-center lg:space-x-2">
            {#each menu as item}
              ...
              <a
                href={item.path}
                use:inertia
                class={pathname == item.path
                  ? "text-sm font-medium flex items-center space-x-2 px-3 py-2   border-b-2 border-white   text-white"
                  : "text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded text-orange-200 border border-transparent hover:text-white "}
              >
                <span>{item.name}</span>
              </a>
            {/each}
        ...
        <div class="flex items-center space-x-1 lg:space-x-2">
          ...
          <div class="lg:hidden">
            <button
              ...
              class="inline-flex justify-center items-center space-x-2 font-semibold focus:outline-none px-3 py-2 leading-5 text-sm text-orange-200 hover:text-white hover:bg-opacity-50 focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-opacity-100 active:shadow-none"
            >
              <svg
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <nav class="flex flex-col space-y-2 py-4">
            {#each menu as item}
              ...
              <a
                ...
                href={item.path}
                class={pathname == item.path
                  ? "text-sm font-medium flex items-center space-x-2 px-3 py-2   border-b border-white   text-white"
                  : "text-sm font-medium flex items-center space-x-2 px-3 py-2   text-orange-200 border border-transparent hover:text-white "}
              >
                <span>{item.name}</span>
              </a>
            {/each}
