      ...
      <div class="container xl:max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div class="flex justify-between py-4">
          ...
          <div class="flex items-center space-x-2 lg:space-x-6">
            <!-- Logo -->
            <a href="/"  class="group inline-flex items-center space-x-2 font-semibold text-lg tracking-wide text-white hover:text-orange-300 active:text-gray-200">
